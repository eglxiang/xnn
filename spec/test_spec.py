...
m1.add(denseLayerSpec(parent=m1.get_layer("concatLayer_2"), num_units=100), output_settings=out_props)
...
l3 = m2.add(denseLayerSpec(parent=l2, num_units=100), output_settings=out_props)
